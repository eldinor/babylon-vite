...
export class NiceLoader {
  ...
  uploadModel(scene: Scene, arr: Array<MeshAssetTask>) {
    ...
    loadButton!.oninput = function (evt) {
      console.log(evt);
      ...
      assetsManager.addMeshTask(
        //  filename + "-" + taskNumber.toString(),
        filename,
        "",
        "file:",
        filename
      );
      console.log("TASK ADDED ", filename + "-" + taskNumber.toString());
    ...
    document.getElementById("exportButton")!.onclick = function (_e) {
      ...
      exportFileName = exportFileName.slice(0, -1) + "-nl";
